...
app.get("/guest/user/:id", checkToken, (req, res, next) =>
  guestServiceProxy(req, res, next)
);
app.get("/guest/:id", checkToken, (req, res, next) =>
  guestServiceProxy(req, res, next)
);
app.post("/guest", checkToken, (req, res, next) =>
  guestServiceProxy(req, res, next)
);
app.put("/guest/:id", checkToken, (req, res, next) =>
  guestServiceProxy(req, res, next)
);
app.delete("/guest/:id", checkToken, (req, res, next) =>
  guestServiceProxy(req, res, next)
);
